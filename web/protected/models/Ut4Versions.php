...
/**
 * This is the model class for table "ut4_versions".
 *
 * The followings are the available columns in table 'ut4_versions':
 * @property string $id
 ...
 */
class Ut4Versions extends CActiveRecord
{
	/**
	 ...
	 * @return Ut4Versions the static model class
	 */

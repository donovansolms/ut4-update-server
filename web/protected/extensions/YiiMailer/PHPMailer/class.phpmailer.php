...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'website@projectlimitless.io';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Project Limitless Website';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'email-smtp.eu-west-1.amazonaws.com';
   ...
   * @var string
   */
  public $Username      = 'AKIAJAUO2ZQTWSWQFFOA';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'AiIm4cuEAkmdLBneUapbPn1HH94OKmM26YAGuE5UzKIt';
